\begin{tabular}{p{1.7cm}p{2.4cm}p{2.4cm}p{2.4cm}p{2.4cm}p{2.2cm}}
\toprule
...
\addlinespace
PoA$^2$ (PureChain) & None (distributed) & Requires majority-of-validators collusion (no single party) & Yes (block height + time) & Public tx/state read via RPC (validator-set query disabled on current public endpoint) & 1,880 (indiv.) / 20 (batch) \\
\addlinespace
\bottomrule
\end{tabular}